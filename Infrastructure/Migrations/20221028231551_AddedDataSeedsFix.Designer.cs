...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221028231551_AddedDataSeedsFix")]
    partial class AddedDataSeedsFix
    {
            ...
            modelBuilder.Entity("Core.Domain.Package", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AvailableUntil = new DateTime(2022, 11, 1, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3536),
                            CanteenId = 1,
                            City = 0,
                            Description = "This box contains a surprise",
                            Meal = 1,
                            Name = "Suprise Box",
                            PickUp = new DateTime(2022, 10, 29, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3499),
                            Price = 10m
                        },
                        new
                        {
                            Id = 2,
                            AvailableUntil = new DateTime(2022, 11, 1, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3545),
                            CanteenId = 1,
                            City = 0,
                            Description = "Half of the box is filled with bread",
                            Meal = 1,
                            Name = "Bread Box",
                            PickUp = new DateTime(2022, 10, 29, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3542),
                            Price = 10m
                        },
                        new
                        {
                            Id = 3,
                            AvailableUntil = new DateTime(2022, 11, 1, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3549),
                            CanteenId = 1,
                            City = 2,
                            Description = "Alot of fresh left over soup ready to be served for dinner!",
                            Meal = 1,
                            Name = "Soup Box",
                            PickUp = new DateTime(2022, 10, 29, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3547),
                            Price = 10m
                        },
                        new
                        {
                            Id = 4,
                            AvailableUntil = new DateTime(2022, 11, 1, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3554),
                            CanteenId = 2,
                            City = 2,
                            Description = " This box contains a gourmet meal",
                            Meal = 1,
                            Name = "Gourmet Box",
                            PickUp = new DateTime(2022, 10, 29, 1, 15, 50, 918, DateTimeKind.Local).AddTicks(3552),
                            Price = 10m
                        });
                });
