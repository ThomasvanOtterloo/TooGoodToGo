...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221103191631_AddedMealAtt@Package")]
    partial class AddedMealAttPackage
    {
            ...
            modelBuilder.Entity("Core.Domain.Package", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AvailableUntil = new DateTime(2022, 11, 6, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1028),
                            Description = "This box contains a surprise",
                            EmployeeId = 1,
                            Meal = 0,
                            Name = "Suprise Box",
                            PickUp = new DateTime(2022, 11, 4, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(991),
                            Price = 10m
                        },
                        new
                        {
                            Id = 2,
                            AvailableUntil = new DateTime(2022, 11, 6, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1036),
                            Description = "Half of the box is filled with bread",
                            EmployeeId = 1,
                            Meal = 0,
                            Name = "Bread Box",
                            PickUp = new DateTime(2022, 11, 4, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1034),
                            Price = 10m
                        },
                        new
                        {
                            Id = 3,
                            AvailableUntil = new DateTime(2022, 11, 6, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1042),
                            Description = "Alot of fresh left over soup ready to be served for dinner!",
                            EmployeeId = 1,
                            Meal = 0,
                            Name = "Soup Box",
                            PickUp = new DateTime(2022, 11, 4, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1040),
                            Price = 10m
                        },
                        new
                        {
                            Id = 4,
                            AvailableUntil = new DateTime(2022, 11, 6, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1047),
                            Description = " This box contains a gourmet meal",
                            EmployeeId = 2,
                            Meal = 0,
                            Name = "Gourmet Box",
                            PickUp = new DateTime(2022, 11, 4, 20, 16, 30, 446, DateTimeKind.Local).AddTicks(1044),
                            Price = 10m
                        });
                });
