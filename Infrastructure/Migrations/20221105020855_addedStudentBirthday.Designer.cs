...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221105020855_addedStudentBirthday")]
    partial class addedStudentBirthday
    {
            ...
            modelBuilder.Entity("Core.Domain.Package", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AvailableUntil = new DateTime(2022, 11, 8, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3068),
                            Description = "This box contains a surprise",
                            EmployeeId = 1,
                            Meal = 0,
                            Name = "Suprise Box",
                            PickUp = new DateTime(2022, 11, 6, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3028),
                            Price = 10m
                        },
                        new
                        {
                            Id = 2,
                            AvailableUntil = new DateTime(2022, 11, 8, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3074),
                            Description = "Half of the box is filled with bread",
                            EmployeeId = 1,
                            Meal = 0,
                            Name = "Bread Box",
                            PickUp = new DateTime(2022, 11, 6, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3072),
                            Price = 10m
                        },
                        new
                        {
                            Id = 3,
                            AvailableUntil = new DateTime(2022, 11, 8, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3079),
                            Description = "Alot of fresh left over soup ready to be served for dinner!",
                            EmployeeId = 1,
                            Meal = 1,
                            Name = "Soup Box",
                            PickUp = new DateTime(2022, 11, 6, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3077),
                            Price = 10m
                        },
                        new
                        {
                            Id = 4,
                            AvailableUntil = new DateTime(2022, 11, 8, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3084),
                            Description = " This box contains a gourmet meal",
                            EmployeeId = 2,
                            Meal = 1,
                            Name = "Gourmet Box",
                            PickUp = new DateTime(2022, 11, 6, 3, 8, 54, 512, DateTimeKind.Local).AddTicks(3082),
                            Price = 10m
                        });
                });
